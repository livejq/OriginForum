<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@ page
	import="java.util.*, cn.justquiet.bean.Teacher, cn.justquiet.bean.Student, cn.justquiet.bean.Question"%>
...
%>
		<div id="questions-detail">
			<div class="q_time">
				<span>${qst.date }来自</span> <a class="user_name" href="#"
					target="_blank">${qst.nickname }</a>
			</div>
			<a href="../viewAnswer?index=<%=start %>&qid=${qst.qid }"
...
%>
	<div id="question-pages-index">
		<ul>
			<li><input type="button" onClick="openPage(1)"
				<%=page_count == 1 ? "disabled" : ""%> value="首页"></li>
			<li><input type="button" onClick="openPage(<%=sum_page%>)"
				<%=page_count == sum_page ? "disabled" : ""%> value="尾页"></li>
			<li><input type="button" onClick="openPage(<%=page_count - 1%>)"
