...
%>
	...
	<div id="adv">
		<div class="banner">
			<div class="ban-img">
				<img class="on" src="../images/1.jpg" alt="" /> <img
					src="../images/2.jpg" alt="" /> <img src="../images/3.jpg" alt="" />
	...
	<div id="search">
		...
		<form action="gather.jsp" method="post">
			<input type="text" name="search" placeholder="输入日期或标题查看作业提交情况" />
		</form>
	</div>
	<div id="content">
		<div class="card">
			<ul>
				<li><img src="../images/java.png" alt="java" class="active"
					id="showFirst" /></li>
			...
			<div class="box-center">
				<div class="box-content">
					<div class="alive">
						...
						<ul class="box-details">
							<li><h2>技术交流</h2></li>
							<li class="box-info">
								JavaOne是首要的Java开发者大会，您可以在其中了解最新的Java技术，加深您的技术理解，并直接向您的战略家和开发人员提问。Oracle每年举办一次JavaOne会议，包括旧金山的旗舰JavaOne和区域会议。</li>
							<li class="btn-details"><a
								href="https://www.oracle.com/javaone/" target="_blank"><input
									type="button" value="查看详情"></a></li>
						</ul>
					</div>
				</div>
				<div class="box-content">
					<div>
						...
						<ul class="box-details">
							<li><h2>Android 8.1 Oreo：不再需要关于Wi-Fi速度的猜测</h2></li>
							<li class="box-info">
								开放式开发模型将红帽工程师与开源社区联系起来。这些社区的成员共同努力，以确定和提升最佳想法。Red
								Hat通过为代码做出贡献以及通过从上游项目创建产品来支持这些社区。从操作系统到存储，中间件和容器
								,一直到管理和自动化,红帽正在为企业构建带有认证和服务的开源解决方案。</li>
							<li class="btn-details"><a
								href="https://developer.android.google.cn/" target="_blank"><input
									type="button" value="查看详情"></a></li>
						</ul>
					</div>
				</div>
				<div class="box-content">
					<div>
						...
						<ul class="box-details">
							<li><h2>为企业构建开源解决方案</h2></li>
							<li class="box-info">
								开放式开发模型将红帽工程师与开源社区联系起来。这些社区的成员共同努力，以确定和提升最佳想法。Red
								Hat通过为代码做出贡献以及通过从上游项目创建产品来支持这些社区。从操作系统到存储，中间件和容器
								,一直到管理和自动化,红帽正在为企业构建带有认证和服务的开源解决方案。</li>
							<li class="btn-details"><a href="https://www.redhat.com/"
								target="_blank"><input type="button" value="查看详情"></a></li>
						</ul>
					</div>
				</div>
				<div class="box-content">
					<div>
						...
						<ul class="box-details">
							<li><h2>MVC+DAO开发模式</h2></li>
							<li class="box-info">
								客户层：因为现在都采用了B/S开发架构，所以一般都使用浏览器进行访问。显示层：使用JSP/Servlet进行页面效果的显示。业务层（Business
								Object，业务对象）：会将多个原子性的DAO操作进行组合，组合成一个完整的业务逻辑。数据层（DAO）：提供多个原子性的DAO操作，例如：增加、修改、删除等，都属于原子性的操作。</li>
							<li class="btn-details"><a href="https://www.apache.com/"
								target="_blank"><input type="button" value="查看详情"></a></li>
						</ul>
					</div>
				</div>
				<div class="box-content">
					<div>
						...
						<ul class="box-details">
							<li><h2>PHP 7.0.33发布</h2></li>
							<li class="box-info">
								PHP是一种流行的通用脚本语言，特别适用于Web开发。快速，灵活和实用，PHP支持从您的博客到世界上最受欢迎的网站的所有内容。</li>
							<li class="btn-details"><a href="https://www.php.net/"
								target="_blank"><input type="button" value="查看详情"></a></li>
						</ul>
					</div>
				</div>
				<div class="box-content">
					<div>
						...
						<ul class="box-details">
							<li><h2>MySQL文档存储</h2></li>
							<li class="box-info">
								MySQL文档存储允许开发人员使用SQL关系表和无架构JSON集合。NoSQL + SQL =
								MySQL,MySQL文档存储为用户提供了开发传统SQL关系应用程序和NoSQL无架构文档数据库应用程序的最大灵活性。这消除了对单独的NoSQL文档数据库的需要。开发人员可以在同一个数据库和同一个应用程序中混合和匹配关系数据和JSON文档。例如，可以在同一个应用程序中查询这两个数据模型，结果可以是表格，表格或JSON格式。</li>
							<li class="btn-details"><a href="https://dev.mysql.com/"
								target="_blank"><input type="button" value="查看详情"></a></li>
						</ul>
					</div>
				</div>
	...
	<div id="footer">
		<div class="favourite">
			<ul>
				<li><img src="../images/logo-wechat.png" alt="" />
					<div>
						<a href="#">微信</a>
					</div></li>
				<li><img src="../images/google_plus_48dp.png" alt="" />
					<div>
						<a href="#">Google+</a>
					</div></li>
				<li><img src="../images/youtube_48dp.png" alt="" />
					<div>
						<a href="#">YouTube</a>
					</div></li>
				<li><svg version="1.1" id="Layer_1"
						xmlns="http://www.w3.org/2000/svg"
						xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
						width="64px" height="64px" viewBox="0 0 64 64"
						enable-background="new 0 0 64 64" xml:space="preserve"> <path
						fill="#5FA9DD"
						d="M64,12.157c-2.355,1.044-4.885,1.75-7.541,2.068c2.711-1.625,4.793-4.198,5.773-7.264
						...
						C60.013,17.103,62.24,14.79,64,12.157z" /></svg>
					<div>
						<a href="#">Twitter</a>
					</div></li>
			</ul>
		...
		<div class="designer">
			<div>
				<span>Copyright&nbsp;<svg version="1.1"
						xmlns="http://www.w3.org/2000/svg" width="24" height="24"
						viewBox="0 0 24 24">
					<title>copyright</title>
					<path
						d="M12 20.016c4.406 0 8.016-3.609 8.016-8.016s-3.609-8.016-8.016-8.016-8.016 3.609-8.016 8.016 3.609 8.016 8.016 8.016zM12 2.016c5.531 0 9.984 4.453 9.984 9.984s-4.453 9.984-9.984 9.984-9.984-4.453-9.984-9.984 4.453-9.984 9.984-9.984zM11.859 9.141c-1.442 0-1.875 1.276-1.875 2.719v0.281c0 1.442 0.434 2.719 1.875 2.719 0.88 0 1.641-0.537 1.641-1.406h1.781c0 0.915-0.495 1.603-1.031 2.063-0.604 0.518-1.308 0.844-2.391 0.844-2.559 0-3.844-1.691-3.844-4.219v-0.281c0-1.212 0.34-2.318 0.938-3 0.619-0.707 1.61-1.266 2.906-1.266 1.038 0 1.904 0.358 2.438 0.891 0.516 0.516 0.984 1.312 0.984 2.297h-1.781c0-0.234-0.047-0.422-0.141-0.609s-0.188-0.422-0.328-0.563c-0.254-0.254-0.688-0.469-1.172-0.469z"></path>
					</svg>&nbsp;2018&nbsp;<i><a href="https://www.justquiet.cn"
						target="_blank">www.justquiet.cn.</a></i>&nbsp;Powered by JSP Core on
					Windows 10
				</span>
			</div>
		</div>
