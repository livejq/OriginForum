...
%>
	...
	<div id="writtenPane">
		<form action="../handleTask" method="post" enctype="multipart/form-data">
		<div class="title-box">
        	<input type="text" id="taskTitle" name="inputTitle" maxlength="60" placeholder="输入作业标题(必填)">
        </div>
        ...
        <div class="s-target">
        	...
        	<div class="deadline">
        		<input type="text" id="deadline" name="deadline" maxlength="2" placeholder="输入期限(必填)">
        	</div>
        	<label>(天数)</label>
        </div>
	    <div class="attach">
		    <div class="addFile">
		       <label for="upload">添加附件</label>
		...
		<div class="taskmess"><span>${param.taskmess }</span></div>
		</form>
	</div>
