<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ page import="java.util.*" import="cn.justquiet.Beans.Teacher" import="cn.justquiet.Beans.Question" import="cn.justquiet.Beans.Answer"%>
...
%>
	...
	<form action="../handleTeaAnswer?index=<%=index %>&qid=${ans.qid }" method="post">
