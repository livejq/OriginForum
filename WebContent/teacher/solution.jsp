<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@ page
	import="java.util.*, cn.justquiet.bean.Teacher, cn.justquiet.bean.Question, cn.justquiet.bean.Answer"%>
...
%>
		...
		<!-- 赞成或反对数超过四位数会溢出，凡是如此，则 统一变成+999-->
		<%
			}
		}
	}
%>
	...
	<form action="../handleTeaAnswer?index=<%=index %>&qid=${ans.qid }"
		method="post">
