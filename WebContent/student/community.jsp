<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ page import="java.util.*" import="cn.justquiet.Beans.Student" import="cn.justquiet.Beans.Question"%>
...
%>			
		<div id="questions-detail">
			<div class="q_time">
			    ...
			    <a class="user_name" href="#">${qst.nickname }</a>
			</div>
			<a href="../viewAnswer?index=<%=start %>&qid=${qst.qid }" class="question-title">
