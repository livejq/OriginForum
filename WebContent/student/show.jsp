<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@ page
	import="java.util.*, cn.justquiet.bean.Student, cn.justquiet.bean.Task"%>
...
%>
		<div id="showContent">
			<div class="task-title">
				<h4>${tknot.tktitle }</h4>
				<em>来自&nbsp;${tknot.tname }&nbsp;老师</em> <span>截止时间：${tknot.cutoff }</span>
			</div>
			<div class="a-total">
				<span>详细说明：</span>
			</div>
			...
			<div class="panel">
				<div class="d-total">
					<span>附件下载：</span> <span><a
						href="../attach?filename=${tknot.attach }" title="下载">${tknot.attach }</a></span>
				</div>
			</div>
		</div>
		<%
...
%>
		<div id="showContent">
			...
			<div class="panel">
				<div class="d-total">
					<span>附件下载：</span> <span><a
						href="../attach?filename=${tk.attach }" title="下载">${tk.attach }</a></span>
				</div>
			</div>
		</div>
		<%
...
%>
		<div id="showContent">
			<div class="task-title">
				...
				<em>来自&nbsp;${ftknot.tname }&nbsp;老师</em> <span>截止时间：${ftknot.cutoff }</span>
			</div>
			<div class="a-total">
				<span>详细说明：</span>
			</div>
			...
			<div class="panel">
				<div class="d-total">
					<span>附件下载：</span> <span><a
						href="../attach?filename=${ftknot.attach }" title="下载">${ftknot.attach }</a></span>
				</div>
			</div>
		</div>
		<%
...
%>
		<div id="showContent">
			...
			<div class="panel">
				<div class="d-total">
					<span>附件下载：</span> <span><a
						href="../attach?filename=${ftkok.attach }" title="下载">${ftkok.attach }</a></span>
				</div>
			</div>
		</div>
		<%
